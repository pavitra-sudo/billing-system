...
from api.services.shop.products import ProductService
from api.schemas.shop.products import *
...
@router.get("/{id}", response_model=ProductResponse, status_code=200, responses= {404: {"description": "Product not found"}})
...
@router.patch("/{id}", response_model=ProductResponse, status_code=200, responses= {404: {"description": "Product not found"}})
